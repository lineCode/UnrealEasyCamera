...
class EASYCAMERA_API USimpleFollow : public UECameraComponentFollow
{
	GENERATED_BODY()
...
protected:
	 ...
	 */
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (ClampMin = "0.0", ClampMax = "1.0", EditCondition = "FollowType == ESimpleFollowType::WorldSpace"))
	FVector AxisMasks;
