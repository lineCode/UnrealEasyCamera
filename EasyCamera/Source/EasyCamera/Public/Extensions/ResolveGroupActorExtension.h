 ...
 */
UCLASS()
class EASYCAMERA_API UResolveGroupActorExtension : public UECameraExtensionBase
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (EditCondition = "ResolveMethod != EResolveGroupActorMethod::DistanceOnly"))
	FVector2f FOVRange;
	...
	UPROPERTY(EditAnywhere, BlueprintReadWrite, meta = (EditCondition = "ResolveMethod != EResolveGroupActorMethod::ZoomOnly"))
	...
	/** Which percent of the overall bounding box will be tolerated. 
