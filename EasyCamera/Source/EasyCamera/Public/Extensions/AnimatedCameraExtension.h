...
class EASYCAMERA_API UAnimatedCameraExtension : public UECameraExtensionBase
{
	GENERATED_BODY()
...
protected:
	...
	UPROPERTY(EditAnywhere, BlueprintReadOnly, meta = (EditCondition = "RefCoordinateActor == nullptr"))
