		...
		if (ActiveCamera && ActiveCamera->GetSettingsComponent()->IsActive())
		{
			...
			if (FollowComponent)
			{
				...
				if (FollowComponent->IsA<UFramingFollow>())
				{
					...
					FVector2f ScreenOffset = FramingFollow->GetScreenOffset();
					FVector2f ScreenOffsetWidth = FramingFollow->GetScreenOffsetWidth();
					FVector2f ScreenOffsetHeight = FramingFollow->GetScreenOffsetHeight();
