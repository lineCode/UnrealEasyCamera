...
// End Cross Module References
	DEFINE_FUNCTION(UECameraLibrary::execGetEPlayerCameraManager)
	{
		P_GET_OBJECT(UObject,Z_Param_WorldContextObject);
		P_GET_PROPERTY(FIntProperty,Z_Param_index);
		P_FINISH;
		P_NATIVE_BEGIN;
		*(AEPlayerCameraManager**)Z_Param__Result=UECameraLibrary::GetEPlayerCameraManager(Z_Param_WorldContextObject,Z_Param_index);
		P_NATIVE_END;
	}
	...
	DEFINE_FUNCTION(UECameraLibrary::execCallAnimatedCamera)
	{
		P_GET_OBJECT(UObject,Z_Param_WorldContextObject);
		P_GET_OBJECT(UAnimSequence,Z_Param_AnimToPlay);
		P_GET_OBJECT(AActor,Z_Param_RefCoordinateActor);
		P_GET_STRUCT(FTransform,Z_Param_RefCoordinate);
		P_GET_STRUCT(FVector,Z_Param_PositionOffset);
		...
		P_FINISH;
		P_NATIVE_BEGIN;
		*(AECameraBase**)Z_Param__Result=UECameraLibrary::CallAnimatedCamera(Z_Param_WorldContextObject,Z_Param_AnimToPlay,Z_Param_RefCoordinateActor,Z_Param_RefCoordinate,Z_Param_PositionOffset,Z_Param_BlendTime,EViewTargetBlendFunction(Z_Param_BlendFunc),Z_Param_BlendExp,Z_Param_bLockOutgoing);
		P_NATIVE_END;
	}
	...
	void UECameraLibrary::StaticRegisterNativesUECameraLibrary()
	{
		...
		static const FNameNativePtrPair Funcs[] = {
			{ "CallAnimatedCamera", &UECameraLibrary::execCallAnimatedCamera },
			...
			{ "GetEPlayerCameraManager", &UECameraLibrary::execGetEPlayerCameraManager },
	...
	struct Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics
	{
		struct ECameraLibrary_eventCallAnimatedCamera_Parms
		{
			const UObject* WorldContextObject;
			UAnimSequence* AnimToPlay;
			AActor* RefCoordinateActor;
		...
		static const UECodeGen_Private::FObjectPropertyParams NewProp_RefCoordinateActor;
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_WorldContextObject_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventCallAnimatedCamera_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_WorldContextObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_WorldContextObject_MetaData)) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_AnimToPlay = { "AnimToPlay", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventCallAnimatedCamera_Parms, AnimToPlay), Z_Construct_UClass_UAnimSequence_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_RefCoordinateActor = { "RefCoordinateActor", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventCallAnimatedCamera_Parms, RefCoordinateActor), Z_Construct_UClass_AActor_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_RefCoordinate = { "RefCoordinate", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventCallAnimatedCamera_Parms, RefCoordinate), Z_Construct_UScriptStruct_FTransform, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FStructPropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_PositionOffset = { "PositionOffset", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Struct, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventCallAnimatedCamera_Parms, PositionOffset), Z_Construct_UScriptStruct_FVector, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_BlendTime = { "BlendTime", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventCallAnimatedCamera_Parms, BlendTime), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FBytePropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_BlendFunc = { "BlendFunc", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Byte, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventCallAnimatedCamera_Parms, BlendFunc), Z_Construct_UEnum_Engine_EViewTargetBlendFunction, METADATA_PARAMS(nullptr, 0) }; // 3430533364
	const UECodeGen_Private::FFloatPropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_BlendExp = { "BlendExp", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Float, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventCallAnimatedCamera_Parms, BlendExp), METADATA_PARAMS(nullptr, 0) };
	void Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_bLockOutgoing_SetBit(void* Obj)
	{
		((ECameraLibrary_eventCallAnimatedCamera_Parms*)Obj)->bLockOutgoing = 1;
	}
	const UECodeGen_Private::FBoolPropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_bLockOutgoing = { "bLockOutgoing", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Bool | UECodeGen_Private::EPropertyGenFlags::NativeBool, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, sizeof(bool), sizeof(ECameraLibrary_eventCallAnimatedCamera_Parms), &Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_bLockOutgoing_SetBit, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventCallAnimatedCamera_Parms, ReturnValue), Z_Construct_UClass_AECameraBase_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_WorldContextObject,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_AnimToPlay,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_RefCoordinateActor,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_RefCoordinate,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_PositionOffset,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_BlendTime,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_BlendFunc,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_BlendExp,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_bLockOutgoing,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::Function_MetaDataParams[] = {
		{ "Category", "ECamera|Utils" },
		{ "Comment", "/** Call an animated camera, i.e., driven by an animation sequence. This is usually used inside a skill.\n\x09 * @param AnimToPlay - The animation sequence you want to play on camera.\n\x09 * @param RefCoordinateActor - In which actor's local space you want to play the camera animation.\n\x09 * @param RefCoordinate - In which reference frame you want to play the camera animation.\n\x09 * @param PositionOffset - Position offset, in reference space.\n\x09 * @param BlendTime - Blend-in time used for transitioning from the current active camera to the new camera.\n\x09 * @param BlendFunc - Which type of blend function to use.\n\x09 * @param BlendExp - Blend exponential.\n\x09 * @param bLockOutgoing - If true, lock outgoing viewtarget to last frame's camera position for the remainder of the blend.\n\x09 */" },
		...
		{ "CPP_Default_PositionOffset", "0.000000,0.000000,0.000000" },
		{ "CPP_Default_RefCoordinate", "()" },
		{ "CPP_Default_RefCoordinateActor", "None" },
		{ "DisplayName", "CallAnimatedCamera" },
		{ "ModuleRelativePath", "Public/Utils/ECameraLibrary.h" },
		{ "ToolTip", "Call an animated camera, i.e., driven by an animation sequence. This is usually used inside a skill.\n@param AnimToPlay - The animation sequence you want to play on camera.\n@param RefCoordinateActor - In which actor's local space you want to play the camera animation.\n@param RefCoordinate - In which reference frame you want to play the camera animation.\n@param PositionOffset - Position offset, in reference space.\n@param BlendTime - Blend-in time used for transitioning from the current active camera to the new camera.\n@param BlendFunc - Which type of blend function to use.\n@param BlendExp - Blend exponential.\n@param bLockOutgoing - If true, lock outgoing viewtarget to last frame's camera position for the remainder of the blend." },
		{ "WorldContext", "WorldContextObject" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UECameraLibrary, nullptr, "CallAnimatedCamera", nullptr, nullptr, sizeof(Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::ECameraLibrary_eventCallAnimatedCamera_Parms), Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x04822401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera_Statics::FuncParams);
		}
	...
	struct Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics
	{
		struct ECameraLibrary_eventGetEPlayerCameraManager_Parms
		{
			const UObject* WorldContextObject;
			int32 index;
			AEPlayerCameraManager* ReturnValue;
		};
#if WITH_METADATA
		static const UECodeGen_Private::FMetaDataPairParam NewProp_WorldContextObject_MetaData[];
#endif
...
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::NewProp_WorldContextObject_MetaData[] = {
		{ "NativeConst", "" },
	};
#endif
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::NewProp_WorldContextObject = { "WorldContextObject", nullptr, (EPropertyFlags)0x0010000000000082, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventGetEPlayerCameraManager_Parms, WorldContextObject), Z_Construct_UClass_UObject_NoRegister, METADATA_PARAMS(Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::NewProp_WorldContextObject_MetaData, UE_ARRAY_COUNT(Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::NewProp_WorldContextObject_MetaData)) };
	const UECodeGen_Private::FIntPropertyParams Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::NewProp_index = { "index", nullptr, (EPropertyFlags)0x0010000000000080, UECodeGen_Private::EPropertyGenFlags::Int, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventGetEPlayerCameraManager_Parms, index), METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FObjectPropertyParams Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::NewProp_ReturnValue = { "ReturnValue", nullptr, (EPropertyFlags)0x0010000000000580, UECodeGen_Private::EPropertyGenFlags::Object, RF_Public|RF_Transient|RF_MarkAsNative, 1, nullptr, nullptr, STRUCT_OFFSET(ECameraLibrary_eventGetEPlayerCameraManager_Parms, ReturnValue), Z_Construct_UClass_AEPlayerCameraManager_NoRegister, METADATA_PARAMS(nullptr, 0) };
	const UECodeGen_Private::FPropertyParamsBase* const Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::PropPointers[] = {
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::NewProp_WorldContextObject,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::NewProp_index,
		(const UECodeGen_Private::FPropertyParamsBase*)&Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::NewProp_ReturnValue,
	};
#if WITH_METADATA
	const UECodeGen_Private::FMetaDataPairParam Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::Function_MetaDataParams[] = {
		{ "Category", "ECamera|Utils" },
		{ "Comment", "/** Get EPlayerCameraManager. */" },
		{ "DisplayName", "GetEPlayerCameraManager" },
		{ "ModuleRelativePath", "Public/Utils/ECameraLibrary.h" },
		{ "ToolTip", "Get EPlayerCameraManager." },
		{ "WorldContext", "WorldContextObject" },
	};
#endif
	const UECodeGen_Private::FFunctionParams Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::FuncParams = { (UObject*(*)())Z_Construct_UClass_UECameraLibrary, nullptr, "GetEPlayerCameraManager", nullptr, nullptr, sizeof(Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::ECameraLibrary_eventGetEPlayerCameraManager_Parms), Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::PropPointers, UE_ARRAY_COUNT(Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::PropPointers), RF_Public|RF_Transient|RF_MarkAsNative, (EFunctionFlags)0x14022401, 0, 0, METADATA_PARAMS(Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::Function_MetaDataParams, UE_ARRAY_COUNT(Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::Function_MetaDataParams)) };
	UFunction* Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager()
	{
		static UFunction* ReturnFunction = nullptr;
		if (!ReturnFunction)
		{
			UECodeGen_Private::ConstructUFunction(&ReturnFunction, Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager_Statics::FuncParams);
		}
		return ReturnFunction;
	}
	...
	const FClassFunctionLinkInfo Z_Construct_UClass_UECameraLibrary_Statics::FuncInfo[] = {
		{ &Z_Construct_UFunction_UECameraLibrary_CallAnimatedCamera, "CallAnimatedCamera" }, // 2320611922
		...
		{ &Z_Construct_UFunction_UECameraLibrary_GetActiveCamera, "GetActiveCamera" }, // 2313883207
		{ &Z_Construct_UFunction_UECameraLibrary_GetEPlayerCameraManager, "GetEPlayerCameraManager" }, // 2749209637
	...
	const FClassRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_ECameraTest_Plugins_EasyCamera_Source_EasyCamera_Public_Utils_ECameraLibrary_h_Statics::ClassInfo[] = {
		{ Z_Construct_UClass_UECameraLibrary, UECameraLibrary::StaticClass, TEXT("UECameraLibrary"), &Z_Registration_Info_UClass_UECameraLibrary, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UECameraLibrary), 1456281757U) },
	};
	static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_UnrealProjects_ECameraTest_Plugins_EasyCamera_Source_EasyCamera_Public_Utils_ECameraLibrary_h_3026619267(TEXT("/Script/EasyCamera"),
